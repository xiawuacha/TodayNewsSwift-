...
class HomeBaseTopicCell: UITableViewCell {

    var filterWords: [FilterWord]?
    
    //举报按钮的点击block
    var closeButtonClosure: ((filterWords: [FilterWord])->())?
    ...
    lazy var stickLabel: UIButton = {
        ...
        stickLabel.setTitleColor(KColor(241, g: 91, b: 94, a: 1.0), forState: .Normal)
        stickLabel.layer.borderColor = KColor(241, g: 91, b: 94, a: 1.0).CGColor
