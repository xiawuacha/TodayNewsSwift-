...
/// RGBA的颜色设置
func KColor(r:CGFloat, g:CGFloat, b:CGFloat, a:CGFloat) -> UIColor {
    return UIColor(red: r / 255.0, green: g / 255.0, blue: b / 255.0, alpha: a)
}

/// 背景灰色
func KGlobalColor() -> UIColor {
    return KColor(245, g: 245, b: 245, a: 1)
}

/// 红色
func KGlobalRedColor() -> UIColor {
    return KColor(245, g: 80, b: 83, a: 1.0)
}
